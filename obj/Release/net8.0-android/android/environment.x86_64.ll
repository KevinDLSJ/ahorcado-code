...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 109, ; uint32_t number_of_assemblies_in_apk (0x6d)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 474, ; uint32_t number_of_dso_cache_entries (0x1da)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.79_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.78_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 34
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2064118737484381636, ; hash 0x1ca5390e39fbfdc4, from name: libaot-aho.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 46
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.76_name, ; name: libaot-System.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.75_name, ; name: libaot-System.Xml.ReaderWriter.dll.so
		ptr null; void* handle (0x0)
	}, ; 92
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.80_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle (0x0)
	}, ; 95
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3919711672353678526, ; hash 0x36659cff9c97e4be, from name: libaot-aho
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 100
	...
	%struct.DSOCacheEntry {
		i64 10743442636989726142, ; hash 0x951860283a8efdbe, from name: aot-aho.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 12934114083504916501, ; hash 0xb37f343b27b00815, from name: aho.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 326
	...
	%struct.DSOCacheEntry {
		i64 14873153847793052094, ; hash 0xce680e9f8b7069be, from name: aot-aho
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 384
	...
	%struct.DSOCacheEntry {
		i64 17339218030913842043, ; hash 0xf0a146ee97aaeb7b, from name: aho
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [109 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6f12726e-6f72-4486-8b36-12ba027752d5\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [20 x i8] c"com.companyname.aho\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [18 x i8] c"libaot-aho.dll.so\00", align 16
...
@.DSOCacheEntry.75_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.76_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.77_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.78_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.79_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.80_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
