...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1361815372, ; hash 0x512ba74c, from name: aho.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2002176184, ; hash 0x7756c8b8, from name: libaot-aho
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 211
	...
	%struct.DSOCacheEntry {
		i64 2083740916, ; hash 0x7c335cf4, from name: aot-aho
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 222
	...
	%struct.DSOCacheEntry {
		i64 3748350165, ; hash 0xdf6b48d5, from name: aho
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 412
	...
	%struct.DSOCacheEntry {
		i64 3972015881, ; hash 0xecc02709, from name: aot-aho.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 439
	...
	%struct.DSOCacheEntry {
		i64 4010342069, ; hash 0xef08f6b5, from name: libaot-aho.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-aho.dll.so
		ptr null; void* handle (0x0)
	}, ; 444
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [109 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
